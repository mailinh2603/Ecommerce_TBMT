<?php $__env->startSection('main-content'); ?>
 ...
 <div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
      ...
      <a href="<?php echo e(route('post.create')); ?>" class="btn btn-primary btn-sm float-right" data-toggle="tooltip" data-placement="bottom" title="Thêm Bài Viết"><i class="fas fa-plus"></i> Thêm Bài Viết</a>
    </div>
    <div class="card-body">
      <div class="table-responsive">
        ...
        <?php else: ?>
          <h6 class="text-center">Không có bài viết nào! Vui lòng tạo bài viết mới.</h6>
        <?php endif; ?>
      </div>
    </div>
</div>
...
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\hau06\Downloads\Ecommerce_TBMT2\Ecommerce_TBMT2\Ecommerce_TBMT\resources\views/backend/post/index.blade.php ENDPATH**/ ?>