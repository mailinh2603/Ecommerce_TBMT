...
<style type="text/css">
  ...
  <div class="invoice-description">
    <div class="invoice-left-top float-left">
      <h6>Invoice to</h6>
      <h3><?php echo e($order->fullname); ?></h3>
      <div class="address">
    ...
    <table class="table table-bordered table-striped">
      ...
      <tbody>
        <?php $__currentLoopData = $order->cart_info; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cart): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <tr>
            <td><?php echo e($cart->product->title ?? 'Product not found'); ?></td> <!-- Eager loaded product -->
      ...
      <tfoot>
        <tr>
          ...
          <th><span>$<?php echo e(number_format($order->sub_total,2)); ?></span></th>
        </tr>
        <tr>
          <th scope="col" class="empty"></th>
          <th scope="col" class="text-right">Total:</th>
          <th><span>$<?php echo e(number_format($order->total_amount,2)); ?></span></th>
        </tr>
      </tfoot>
    </table>
  </section>
...
<?php /**PATH C:\Users\hau06\Downloads\Ecommerce_TBMT2\Ecommerce_TBMT2\Ecommerce_TBMT\resources\views/backend/order/pdf.blade.php ENDPATH**/ ?>