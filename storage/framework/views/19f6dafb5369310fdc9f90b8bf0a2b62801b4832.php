                        ...
                        <ul class="list-main">
                            <?php if(auth()->guard()->check()): ?>
                                <?php if(Auth::user()->role=='admin'): ?>
                                    ...
                                    <li><i class="ti-user"></i> <a href="<?php echo e(route('admin')); ?>"  target="_blank">Trang chủ</a></li>
                                <?php else: ?>
                                    <li><i class="fa fa-truck"></i> <a href="<?php echo e(route('order.track')); ?>">Theo dõi đơn hàng</a></li>
                                    <li><i class="ti-user"></i> <a href="<?php echo e(route('user')); ?>"  target="_blank">Trang chủ</a></li>
                                <?php endif; ?>
                                <li><i class="ti-power-off"></i> <a href="<?php echo e(route('user.logout')); ?>">Đăng xuất</a></li>
                            <?php else: ?>
                                <li><i class="fa fa-sign-in"></i><a href="<?php echo e(route('login.form')); ?>">Đăng nhập /</a> <a href="<?php echo e(route('register.form')); ?>">Đăng ký</a></li>
                            <?php endif; ?>
                        </ul>
                    </div>
                    <!-- End Top Right -->
                                ...
                                <div class="navbar-collapse">
                                    <div class="nav-inner">
                                        <ul class="nav main-menu menu navbar-nav">
                                            ...
                                            <li class="<?php echo e(Request::path()=='about-us' ? 'active' : ''); ?>"><a href="<?php echo e(route('about-us')); ?>">Giới thiệu</a></li>
                                            <li class="<?php if(Request::path()=='product-grids'||Request::path()=='product-lists'): ?>  active  <?php endif; ?>"><a href="<?php echo e(route('product-grids')); ?>">Sản phẩm</a><span class="new">New</span></li>
...
<?php /**PATH C:\Users\hau06\Downloads\Ecommerce_TBMT2\Ecommerce_TBMT2\Ecommerce_TBMT\resources\views/frontend/layouts/header.blade.php ENDPATH**/ ?>