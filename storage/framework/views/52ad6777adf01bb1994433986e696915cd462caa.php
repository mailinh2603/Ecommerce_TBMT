				...
				<div class="row">
					<div class="col-lg-5 col-md-6 col-12">
						...
						<div class="single-footer about">
							...
							<p class="call">Nếu bạn có thắc mắc hãy liên hệ<span><a href="tel:123456789"><?php $__currentLoopData = $settings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <?php echo e($data->phone); ?> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?></a></span></p>
						</div>
						<!-- End Single Widget -->
					</div>
				...
				<div class="inner">
					<div class="row">
						<div class="col-lg-6 col-12">
							<div class="left">
								<p>© <?php echo e(date('Y')); ?> Phát triển bởi nhóm 5</p>
							</div>
						</div>
						<div class="col-lg-6 col-12">
							<div class="right">
...
<?php /**PATH C:\Users\hau06\Downloads\Ecommerce_TBMT2\Ecommerce_TBMT2\Ecommerce_TBMT\resources\views/frontend/layouts/footer.blade.php ENDPATH**/ ?>