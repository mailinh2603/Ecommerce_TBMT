                            ...
                            <?php if(Helper::getAllProductFromCart()): ?>
                                <?php $__currentLoopData = Helper::getAllProductFromCart(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$cart): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        ?>
                                        <td class="image" data-title="Không"><img src="<?php echo e($photo[0]); ?>" alt="<?php echo e($photo[0]); ?>"></td>
                                        ...
                                        <td class="price" data-title="Giá"><span><?php echo e(number_format($cart['price'], 0, ',', '.')); ?>₫</span></td>
                                        ...
                                        <td class="total-amount cart_single_price" data-title="Tổng cộng"><span class="money"><?php echo e(number_format($cart['amount'], 0, ',', '.')); ?>₫</span></td>
                                        <td class="action" data-title="Xóa"><a href="<?php echo e(route('cart-delete',$cart->id)); ?>"><i class="ti-trash remove-icon"></i></a></td>
                                    </tr>
                            ...
                            <?php else: ?>
                                <tr>
                                    <td class="text-center">
                                        Giỏ hàng của bạn hiện tại trống. <a href="<?php echo e(route('product-grids')); ?>" style="color:blue;">Tiếp tục mua sắm</a>
                                    </td>
                                </tr>
                            <?php endif; ?>
                        </form>
                ...
                <div class="total-amount">
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-7 col-12">
                            <div class="right">
                                <ul>
                                    <li class="order_subtotal" data-price="<?php echo e(Helper::totalCartPrice()); ?>">Tổng giá giỏ hàng<span><?php echo e(number_format(Helper::totalCartPrice(), 0, ',', '.')); ?>₫</span></li>

                                    <?php if(session()->has('coupon')): ?>
                                    <li class="coupon_price" data-price="<?php echo e(Session::get('coupon')['value']); ?>">Tiết kiệm<span><?php echo e(number_format(Session::get('coupon')['value'], 0, ',', '.')); ?>₫</span></li>
                                    <?php endif; ?>
                                    <?php
                                    ...
                                    ?>
                                    <?php if(session()->has('coupon')): ?>
                                        <li class="last" id="order_total_price">Tổng cộng<span><?php echo e(number_format($total_amount, 0, ',', '.')); ?>₫</span></li>
                                    <?php else: ?>
                                        <li class="last" id="order_total_price">Tổng cộng<span><?php echo e(number_format($total_amount, 0, ',', '.')); ?>₫</span></li>
                                    <?php endif; ?>
                                </ul>
                                <div class="button5">
                                    ...
                                    <a href="<?php echo e(route('product-grids')); ?>" class="btn">Tiếp tục mua sắm</a>
                                </div>
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\hau06\Downloads\Ecommerce_TBMT2\Ecommerce_TBMT2\Ecommerce_TBMT\resources\views/frontend/pages/cart.blade.php ENDPATH**/ ?>