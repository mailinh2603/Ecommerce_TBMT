      ...
      <div class="col-xl-12 col-lg-12">
        ...
        ?>
            ...
            ?>
              ...
              <?php else: ?>
                <td colspan="8" class="text-center"><h4 class="my-4">Không tìm thấy đơn hàng.</h4></td>
              <?php endif; ?>
          </tbody>
        </table>
...
<?php echo $__env->make('user.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\hau06\Downloads\Ecommerce_TBMT2\Ecommerce_TBMT2\Ecommerce_TBMT\resources\views/user/index.blade.php ENDPATH**/ ?>