                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="fullname" placeholder="" value="<?php echo e(old('fullname')); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-12">
                                        <div class="form-group">
                                            <label>Địa chỉ</label>
                                            <input type="text" name="address" placeholder="" value="<?php echo e(old('address')); ?>">
...
<div class="col-lg-4 col-md-4 col-12">
    ...
    Tổng phụ giỏ hàng
    <span><?php echo e(Helper::totalCartPrice()); ?>₫</span>
</li>

                    <li class="fee-shipping">Phí vận chuyển : <span>0₫</span></li>

                    <?php if(session('coupon')): ?>
                    <li class="coupon_price" data-price="<?php echo e(session('coupon')['value']); ?>">Giảm giá<span><?php echo e(number_format(session('coupon')['value'], 0, ',', '.')); ?>₫</span></li>
                    <?php endif; ?>
                    <?php
...
$(document).ready(function() {
        ...
        function generateQRCode() {
            const totalAmount = '<?php echo e($total_amount); ?>'; // Use the Blade variable for total amount
            const qrData = {
...
$(document).ready(function() {
  ...
  fetch("<?php echo e(asset('frontend/js/full_json_generated_data_vn_units.json')); ?>")
    .then((response) => {
      if (!response.ok) {
...
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\hau06\Downloads\Ecommerce_TBMT2\Ecommerce_TBMT2\Ecommerce_TBMT\resources\views/frontend/pages/checkout.blade.php ENDPATH**/ ?>