<ul class="navbar-nav bg-gradient-info sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <li class="nav-item">
        ...
        <div id="categoryCollapse" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="{{route('category.create')}}">Thêm loại sản phẩm</a>
          </div>
        </div>
    </li>
    {{-- Products --}}
    ...
    <li class="nav-item">
        ...
        <div id="brandCollapse" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="{{route('brand.index')}}">Các Hãng</a>
            <a class="collapse-item" href="{{route('brand.create')}}">Thêm hãng</a>
          </div>
        </div>
    </li>
     ...
     <li class="nav-item">
        ...
        <div id="postCategoryCollapse" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="{{route('post-category.index')}}"> loại bài viết</a>
            <a class="collapse-item" href="{{route('post-category.create')}}">Thêm loại bài viết</a>
          </div>
        </div>
      </li>
    ...
    <li class="nav-item">
        ...
        <div id="report" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Category Options:</h6>
            <a class="collapse-item" href="{{route('order.reportgetSalesList')}}"> Doanh thu</a>
            <a class="collapse-item" href="{{route('product.inventory')}}">Sản phẩm tồn kho</a>
          </div>
        </div>
      </li>
