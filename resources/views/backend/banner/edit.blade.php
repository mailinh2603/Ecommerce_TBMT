...
@section('title','Ecommerce Laravel || Chỉnh sửa Banner')
    ...
    <div class="card-body">
      <form method="post" action="{{route('banner.update',$banner->id)}}">
        ...
        <div class="form-group">
          ...
          <input id="inputTitle" type="text" name="title" placeholder="Điền tiêu đề" value="{{$banner->title}}" class="form-control">
          @error('title')
