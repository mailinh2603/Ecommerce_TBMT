...
@section('title','Ecommerce Laravel || Nhà Phân Phối')
@section('main-content')
 ...
 <div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
      ...
      <a href="{{route('brand.create')}}" class="btn btn-primary btn-sm float-right" data-toggle="tooltip" data-placement="bottom" title="Thêm Nhà Phân Phối"><i class="fas fa-plus"></i> Thêm Nhà Phân Phối</a>
    </div>
    <div class="card-body">
